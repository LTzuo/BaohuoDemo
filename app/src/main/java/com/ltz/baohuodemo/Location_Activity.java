...
public class Location_Activity extends CheckPermissionsActivity
	...
	private Button btLocation,bt_lover;
	...
	private void initView(){
		...
		bt_lover = (Button) findViewById(R.id.bt_lover);
		rgLocationMode.setOnCheckedChangeListener(this);
		btLocation.setOnClickListener(this);
		bt_lover.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.bt_lover){
			Toast.makeText(Location_Activity.this,"查看行驶轨迹",Toast.LENGTH_SHORT).show();
		}
	}
		...
		public void onLocationChanged(AMapLocation location) {
			if (null != location) {
				...
				if(location.getErrorCode() == 0){
					nodeList.add(new LatLng(location.getLongitude(),location.getLatitude()));
					geTmileage();
//					if(location.getLocationQualityReport().getGPSSatellites() == 0){
//						Toast.makeText(Location_Activity.this,"没有Gps信号",Toast.LENGTH_SHORT).show();
//					}
//					else if(location.getLocationQualityReport().getGPSSatellites() >= 0 || location.getLocationQualityReport().getGPSSatellites()<5){
//							Toast.makeText(Location_Activity.this,"Gps信号弱",Toast.LENGTH_SHORT).show();
//						}
//					else{
//						Toast.makeText(Location_Activity.this,"Gps信号强",Toast.LENGTH_SHORT).show();
//					}
	...
	private void geTmileage(){
		 if(!nodeList.isEmpty() && nodeList.size()>=2) {
			 LatLng var0 = null, var1 = null;
			 for (int i = 0; i < nodeList.size(); i++) {
				 var1 = nodeList.get(nodeList.size() - 1);
